  ...
  return (
    <div className="flex">
      <div className="relative lg:hidden">
        ...
        {isMobileMenuOpen && (
          <div className="absolute left-0 top-12 bg-white shadow-lg w-48 z-10">
            <ul>
              <li 
                className={`py-2 text-gray-700 cursor-pointer hover:text-gray-900 ${!selectedCategory ? 'font-bold' : ''}`}
                onClick={() => {
              ...
              {categories.map((category) => (
                <li
                  key={category}
                  className={`py-2 text-gray-700 cursor-pointer hover:text-gray-900 ${selectedCategory === category ? 'font-bold' : ''}`}
                  onClick={() => {
      ...
      <div className="w-1/4 bg-gray-100 p-4 hidden lg:block">
